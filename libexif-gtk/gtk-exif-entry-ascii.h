...
#define GTK_EXIF_ENTRY_ASCII(o)       (G_TYPE_CHECK_INSTANCE_CAST((o),GTK_EXIF_TYPE_ENTRY_ASCII,GtkExifEntryAscii))
#define GTK_EXIF_ENTRY_ASCII_CLASS(k) (G_TYPE_CHECK_CLASS_CAST((k),GTK_EXIF_TYPE_ENTRY_ASCII,GtkExifEntryAsciiClass))
...
GType    gtk_exif_entry_ascii_get_type (void);
